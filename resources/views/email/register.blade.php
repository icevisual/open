...
<html>
	...
	<div class="mail">
	  ...
	  <div class="section">
	   <h1 class="title-h1">尊敬的 {{$email}}，您好：</h1>
	    <h3 class="title-h3">感谢您使用气味王国开放平台。</h3>
	    <h3 class="title-h3">请点击以下验证按钮进行邮箱验证，以开始使用您的气味王国开放平台账户 ：</h3>
	    <a  class="btn-qwwg a" href="{{$validateUrl}}">马上验证邮箱</a>
	    <p class="title-p">如果您无法点击以上按钮，请复制以下链接到浏览器里直接打开（该链接在 24 小时内有效，24 小时后需要重新注册）：</p>
	    <a class="title-a" href="{{$validateUrl}}">{{$validateUrl}}</a>
