...
class GeetestLib {
     ...
     */
    public function __construct($type, $captcha_id = '', $private_key = '') {
        $config = \Config::get('services.geetest');
        if($type == 'pc'){
            $this->captcha_id  = $config['CAPTCHA_ID'];
            $this->private_key = $config['PRIVATE_KEY'];;
        }elseif ($type == 'mobile') {
            $this->captcha_id  = $config['MOBILE_CAPTCHA_ID'];;
            $this->private_key = $config['MOBILE_PRIVATE_KEY'];;
        }
        $captcha_id && $this->captcha_id  = $captcha_id;
        $private_key && $this->private_key = $private_key;
    }
